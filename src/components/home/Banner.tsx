    ...
    return (
        ...
        <div className="w-full px-6 lg:px-20 3xl:p-16">
            <div className='relative'>
                <div className="h-[130vh] w-full inverted-radius">
                    <Image
                    ...
                    {/* Black Overlay */}
                    <div className="absolute inset-0 bg-black opacity-40 z-10 rounded-3xl" />
                ...
                {/* Button */}
                <button className="bg-secondary absolute bottom-0 flex items-center gap-2 text-white py-[20px] px-[70px] rounded-[14px] font-semibold z-10">
