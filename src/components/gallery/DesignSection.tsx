...
const DesignSection = () => {
    return (
        <div className="w-full px-4 sm:px-6 lg:px-10 2xl:p-16 mt-14 min-h-screen bg-gradient-to-r from-[#2C2F40] to-[#D6DCFF] border-t-[3px] border-b-[3px] border-l-0 border-[#d6dcff5f] rounded-xl py-12 flex flex-col items-center overflow-x-hidden">
            <div className="flex flex-wrap justify-center gap-6 w-full">
                {images.map((src, index) => (
                    <div
                        key={index}
                        className="relative bg-white rounded-xl overflow-hidden w-[32%] h-[400px] max-xl:w-[40%] max-md:w-[70%]"
                    >
